...
#### 1. `/Users/jet/Sage/sage_mcp_stdio_single.py`
...
#### 1. `/Users/jet/Sage/scripts/test_circuit_breaker_reset.py`
- 完整的断路器功能测试
- 模拟故障和恢复场景
- 验证重置功能正确性

#### 2. `/Users/jet/Sage/scripts/test_simple_reset.py`
- 简化的功能测试
- 模拟MCP工具调用逻辑
- 日志记录验证
...
#### 1. `/Users/jet/Sage/docs/指南/Sage_MCP部署指南.md`
...
- **参数验证**：检查断路器名称有效性
- **操作日志**：记录到`/Users/jet/Sage/logs/circuit_breaker_reset.log`
...
操作已记录到: /Users/jet/Sage/logs/circuit_breaker_reset.log
```
